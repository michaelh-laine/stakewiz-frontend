...
const TopBar: FC = () => {
    ...
    return (
      <div>
        ...
        <Navbar key='navbar' bg="none" variant="dark" expand="lg" className='sol-nav-shell'>
          <Container className='navbar-flex-container'>
            ...
            <Navbar.Collapse id="basic-navbar-nav" className='position-relative justify-content-end align-items-center text-white'>
              ...
              <Nav>
                ...
                <Nav.Link href="/" className='text-white'>Network</Nav.Link>
                <Nav.Link href="/stakes" className='text-white'>Portfolio</Nav.Link>
                <Nav.Link href="/faq" className='text-white'>Insights</Nav.Link>
                <Nav.Link href="/validator/GE6atKoWiQ2pt3zL7N13pjNHjdLVys8LinG8qeJLcAiL" target="_new" className='text-warning fw-bold'>Delegate</Nav.Link>
...
class Footer extends React.Component {
  ...
  render() {
      return (
        <footer className='container-fluid footer bg-dark p-5 text-white text-center sol-footer-shell'>
