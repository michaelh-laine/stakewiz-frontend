...
const FAQS: FaqEntry[] = [
    {
        id: 'faq-1',
        question: 'How are validators ranked?',
        answer: (
            <p>
    ...
    {
        id: 'faq-2',
        question: 'How is the stake concentration score calculated?',
        answer: (
            <>
                <p>
                ...
                <p>
                    Low stake is every other validator, which still includes validators that are &quot;above-average&quot;, since the average stake on Solana is approximately ◎ 200,000.
                </p>
                <p>
    ...
    {
        id: 'faq-apy',
        question: 'How is the APY estimated?',
        answer: (
            <>
                <p>
                    Estimating APY can be difficult. APY is the compounded annual yield you can expect on your stake. This means we need to factor in the validator&apos;s performance, the network&apos;s average performance, the total inflation and the total active stake, as well as how many epochs there are in a calendar year.
                </p>
                <p>
                ...
                <p>
                    At the end of April 2024 our TrueAPY method was updated to take the median of the last 10 epochs of real achieved APY. This eliminates short-term outlying performance and provides a smoothed and realistic long-term yield estimate.
                </p>
                <p>
    ...
    {
        id: 'faq-3',
        question: 'What does the red border and delinquency flag mean?',
        answer: (
            <p>
    ...
    {
        id: 'faq-5',
        question: 'Why should I care about delinquency and commission changes?',
        answer: (
            <>
                <p>
                    If you&apos;re staking with a validator and they become delinquent this means they are no longer voting and participating in the chain&apos;s consensus. Your staking rewards are a direct result of the validator&apos;s voting record, since every vote earns them &quot;credits&quot;. At the end of the epoch the blockchain awards staking rewards to stake accounts based on their validator&apos;s total credits.
                </p>
                <p>
    ...
    {
        id: 'faq-6',
        question: 'Are there other ways to receive alerts?',
        answer: (
            <p>
    ...
    {
        id: 'faq-7',
        question: 'How often do I get an alert when a validator is delinquent?',
        answer: (
            <p>
                Just once per delinquency period, when the delinquency first exceeds your chosen threshold. We might add a second email to let you know when they&apos;re no longer delinquent, but we haven&apos;t implemented this yet.
            </p>
        )
    },
    {
        id: 'faq-owners',
        question: 'I run a validator — how do I manage my profile?',
        answer: (
            <>
                <p>
                    Validator operators can claim their profile by connecting the Solana wallet registered as the profile owner and signing a verification message (free of charge — it&apos;s a signature, not a transaction). Once verified, editing tools appear on your validator page, including the ability to post public updates for your stakers: announcements, incident reports and roadmap posts.
                </p>
                <p>
                    To register or change your owner wallet, get in touch with us via Discord.
                </p>
            </>
        )
    },
    {
        id: 'faq-8',
        question: 'How can I submit feedback or get in touch?',
        answer: (
            <p>
                You can find us on Twitter at <a href="https://twitter.com/laine_sa_" target="_new">@laine_sa_</a> or <a href="https://discord.com/invite/solstrategies" target="_new">join our Discord</a>.
            </p>
        )
    },
    {
        id: 'faq-wizscore',
        question: 'How is the Wiz Score calculated?',
        answer: <WizScoreWeightings />
    }
];
    ...
    return (
        <div>
            ...
            <main>
                ...
                <div className="sw-faq" id="vlist">
                    <div className="sw-faq-eyebrow">Support</div>
                    <h1 className="sw-faq-title">Frequently Asked Questions</h1>
                    <p className="sw-faq-intro">
                        How Stakewiz ranks validators, estimates yield and keeps your stake safe.
                    </p>

                    <nav className="sw-faq-toc" aria-label="FAQ contents">
                        <div className="sw-faq-toc-title">On this page</div>
                        <ol>
                            {FAQS.map(faq => (
                                <li key={faq.id}>
                                    <Link href={'#' + faq.id}>{faq.question}</Link>
                                </li>
                            ))}
                        </ol>
                    </nav>
                    ...
                    {FAQS.map(faq => (
                        <section className="sw-faq-item" key={faq.id} id={faq.id}>
                            <h3>{faq.question}</h3>
                            {faq.answer}
                        </section>
                    ))}
